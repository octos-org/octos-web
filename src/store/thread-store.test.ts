 ...
 *
 * These cover the retained old-server fallback only. Canonical v2 behavior
 * is tested independently through ProjectionStore and its render adapter.
 */

import { afterEach, describe, expect, it, vi } from "vitest";
import * as ThreadStore from "./thread-store";
import { __resetProjectionForTests } from "./projection-store";
import {
...
describe("thread-store legacy fallback", () => {
